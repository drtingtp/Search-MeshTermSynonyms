...
1. To find a good example of MeSH term with the following criteria:
    ...
    1. MeSH term search retrieves records which do not show up in textword search.

    1. Textword search retrieves records which do not show up in MeSH term search.
